...
const EnvSchema = z.object({
  ...
  AI_PROVIDER: z.enum(['bedrock', 'gemini', 'groq', 'local']).default('local'),
  ...
  GROQ_MODEL_ID: z.string().default('openai/gpt-oss-20b'),
  GROQ_MAX_OUTPUT_TOKENS: z.coerce.number().min(64).max(2048).default(512),
